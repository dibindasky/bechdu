...
import 'package:beachdu/application/business_logic/auth/auth_bloc.dart' as _i17;
...
import 'package:beachdu/data/service/place_oreder/place_order_service.dart'
    as _i13;
import 'package:beachdu/data/service/questions/questions_service.dart' as _i15;
...
import 'package:beachdu/domain/repository/question_repo.dart' as _i14;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i14.QuestionRepo>(() => _i15.QuestionService());
    gh.factory<_i16.QuestionTabBloc>(
        () => _i16.QuestionTabBloc(gh<_i14.QuestionRepo>()));
    gh.factory<_i17.AuthBloc>(() => _i17.AuthBloc(gh<_i3.AuthRepo>()));
    gh.factory<_i18.HomeBloc>(() => _i18.HomeBloc(gh<_i8.HomeRepository>()));
    gh.factory<_i19.LocationBloc>(
        () => _i19.LocationBloc(gh<_i10.LocationRepo>()));
    gh.factory<_i20.PlaceOrderBloc>(
        () => _i20.PlaceOrderBloc(gh<_i12.PlaceOrderRepo>()));
    return this;
  }
}
